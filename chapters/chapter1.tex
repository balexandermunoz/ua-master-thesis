...
Urban Management Platforms have emerged as essential tools for modern cities, providing integrated perspectives of territorial dynamics through real-time data aggregation, historical analysis, and predictive capabilities~\cite{smart_city_platforms}. These platforms leverage Internet of Things (IoT) technologies to integrate data from diverse urban infrastructure domains~\cite{urban_platform_iot}, enabling data-driven governance and decision-making~\cite{urban_data_platforms}. Ubiwhere's Urban Management Platform, launched in 2018, exemplifies this approach by offering a comprehensive digital solution for efficient land management aligned with international standards and best practices. The platform enables stakeholders to not only monitor current conditions but also analyze historical trends and support strategic planning through the use of artificial intelligence.
